...
const refreshAcessToken= asyncHandler(async(req,res)=>{
    ...
    try {
        ...
        .json(
            new ApiResponse(200, {accessToken,refreshToken: newRefreshToken},"Access token refresh successfull")
        )
    } catch (error) {
...
const updateUserCoverImage= asyncHandler(async(req,res)=>{
    ...
    const coverImage= await uploadOnCloudinary(coverImageLocalPath)
    if(!coverImage.url)throw new ApiError(400,"Something went wrong while uploading Avatar");
